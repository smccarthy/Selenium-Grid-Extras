...
public class Config {
    ...
    public static final String CUSTOM_CAPABILITIES = "custom_capabilities";
    ...
    private void initialize() {
        ...
        getConfigMap().put(CUSTOM_CAPABILITIES, new ArrayList<String>());
    ...
    public List<String> getCustomCapabilites() {
        return (List<String>) getConfigMap().get(CUSTOM_CAPABILITIES);
    }
